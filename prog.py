...
#         call(arr, tar, res + [arr[i]], i + 1,res1)  # [1, 3][4]  to avoid reuse
# """✅ Reason:"""
# a=[1,2,3,4,5,6,7,8]
# t=10
# res1=[]
...
You are choosing items, but the order is irrelevant.
🧠 Example:
If you have numbers [1, 2, 3] and you pick 2 of them:
Combinations are:
[1, 2], [1, 3], [2, 3]
...
🔹 PERMUTATION
→ Order does matter.
You are arranging the items, so different orders count as different.
🧠 Example:
For the same numbers [1, 2, 3], picking 2 of them:
Permutations are:
[1, 2], [2, 1], [1, 3], [3, 1], [2, 3], [3, 2]
✅ [1, 2] and [2, 1] are different permutations.

🧩 Summary Table
Concept	Order matters?	Example (n=3, r=2)	Count Formula
Combination	❌ No	[1,2], [1,3], [2,3]	nCr = n! / (r!(n−r)!)
Permutation	✅ Yes	[1,2], [2,1], [1,3], [3,1], [2,3], [3,2]	nPr = n! / (n−r)!
"""
...
#         self.next = next
#
# # Brute-force method to merge k sorted linked lists
...
#_BST_________________________________________________________________________________________________________________
# class Node:
#     def __init__(self, data):
#         self.data = data
#         self.left = None
